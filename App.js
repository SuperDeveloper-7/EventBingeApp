    ...
    render() {
        if(this.state.promoter === null){
            return <Gradient style={{flex: 1}}>
                ...
                <Animate style={styles.container}>
                    <Image source={require('./logo.png')} resizeMode="contain" style={styles.image}/>
                </Animate>
        ...
        return <NativeRouter>
            <Gradient style={{flex: 1}}>
                ...
                <Route exact path="/" render={(props) => <Login goBack={()=>this.setState({promoter:null})} {...this.state} {...props} login={this.login}/>}/>
